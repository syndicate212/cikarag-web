...
<footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 footer-info">
            <img src="{{ asset('storage/img-logo/logo_desa.png') }}" alt="Logo" width="300">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>2025</span></strong>. || Repost By : <a href="https://www.youtube.com/@kaseps8304/videos">SYNDICATE</a>
      </div>
    </div>
  </footer><!-- End Footer -->